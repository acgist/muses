...
public class GatewaySession implements Serializable {
	...
	public GatewaySession buildSuccess(Map<String, Object> response) {
		...
		this.responseData.put(Gateway.GATEWAY_CODE, MessageCode.CODE_0000.getCode());
		this.responseData.put(Gateway.GATEWAY_MESSAGE, MessageCode.CODE_0000.getMessage());
		return this;
	}
