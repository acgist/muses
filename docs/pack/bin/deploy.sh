...
# 拷贝文件
cp -rf ${project.basedir}/target/${project.artifactId}-${project.artifactId}/* ${system.maven.run.path}${project.artifactId}
# 如果使用SpringBoot-repackage打包覆盖文件
#cp -rf ${project.basedir}/target/${project.artifactId}-${project.artifactId}.jar ${system.maven.run.path}${project.artifactId}
